 ...
 * A ElStoreAddress.
 */
@Document(indexName = "elstoreaddress")
public class ElStoreAddress implements Serializable {
    ...
    public ElStoreAddress customerId(String customerId) {
    ...
    public ElStoreAddress pincode(Long pincode) {
    ...
    public ElStoreAddress houseNoOrBuildingName(String houseNoOrBuildingName) {
    ...
    public ElStoreAddress roadNameAreaOrStreet(String roadNameAreaOrStreet) {
    ...
    public ElStoreAddress city(String city) {
        this.city = city;
        return this;
    }
    ...
    public ElStoreAddress state(String state) {
        this.state = state;
        return this;
    }
    ...
    public ElStoreAddress landmark(String landmark) {
    ...
    public ElStoreAddress name(String name) {
        this.name = name;
        return this;
    }
    ...
    public ElStoreAddress phone(Long phone) {
        this.phone = phone;
        return this;
    }
    ...
    public ElStoreAddress alternatePhone(Long alternatePhone) {
    ...
    public ElStoreAddress addressType(String addressType) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ElStoreAddress)) {
            return false;
        }
        return id != null && id.equals(((ElStoreAddress) o).id);
    }
